...
func List(ctx context.Context, parent *cobra.Command, networkhealthchecksService lbaasSdk.NetworkHealthCheckService) {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			result0, err := networkhealthchecksService.List(ctx, lbID, options)
