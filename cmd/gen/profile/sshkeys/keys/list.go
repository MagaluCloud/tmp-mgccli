...
func List(ctx context.Context, parent *cobra.Command, keysService sshkeysSdk.KeyService) {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			var opts sshkeysSdk.ListOptions
			...
			result0, err := keysService.List(ctx, opts)
