...
*   FILE ID: base-cli-gen/cmd/gen/lbaas/networkhealthchecks/list.go
*	
*	CUSTOM: base-cli-custom/cmd/gen/lbaas/networkhealthchecks/list.go
*	
*/
...
func List(ctx context.Context, parent *cobra.Command, networkHealthCheckService lbaasSdk.NetworkHealthCheckService) {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error{
			...
			networkpaginatedhealthcheckresponse, err := networkHealthCheckService.List(ctx, lbID, options)
			...
			beautiful.NewOutput(raw).PrintData(networkpaginatedhealthcheckresponse)
			return nil
		},
	}
