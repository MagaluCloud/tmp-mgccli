...
func List(ctx context.Context, parent *cobra.Command, schedulersService blockstorageSdk.SchedulerService) {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			var opts blockstorageSdk.SchedulerListOptions
			...
			if opts_ExpandFlag.IsChanged() {
				opts.Expand = flags.StrSliceFlagToSlice[blockstorageSdk.ExpandSchedulers](opts_ExpandFlag)
			...
			result0, err := schedulersService.List(ctx, opts)
