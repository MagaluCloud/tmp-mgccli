...
func List(ctx context.Context, parent *cobra.Command, networkbackendsService lbaasSdk.NetworkBackendService) {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			result0, err := networkbackendsService.List(ctx, lbID, options)
