...
*   FILE ID: base-cli-gen/cmd/gen/blockstorage/snapshots/listall.go
*	
*	CUSTOM: base-cli-custom/cmd/gen/blockstorage/snapshots/listall.go
*	
*/
...
func ListAll(ctx context.Context, parent *cobra.Command, snapshotService blockstorageSdk.SnapshotService) {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error{
			...
			filterOpts := blockstorageSdk.SnapshotFilterOptions{}// ServiceSDKParamCreate
			...
			snapshot, err := snapshotService.ListAll(ctx, filterOpts)
