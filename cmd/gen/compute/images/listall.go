...
func ListAll(ctx context.Context, parent *cobra.Command, imagesService computeSdk.ImageService) {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			var opts computeSdk.ImageFilterOptions
			...
			result0, err := imagesService.ListAll(ctx, opts)
