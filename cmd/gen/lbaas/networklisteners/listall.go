...
func ListAll(ctx context.Context, parent *cobra.Command, networklistenersService lbaasSdk.NetworkListenerService) {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			result0, err := networklistenersService.ListAll(ctx, lbID)
