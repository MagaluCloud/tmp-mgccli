...
*   FILE ID: base-cli-gen/cmd/gen/kubernetes/nodepools/nodes.go
*	
*	CUSTOM: base-cli-custom/cmd/gen/kubernetes/nodepools/nodes.go
*	
*/
...
func Nodes(ctx context.Context, parent *cobra.Command, nodePoolService kubernetesSdk.NodePoolService) {
	...
	cmd := &cobra.Command{
		Use:     "nodes [clusterID] [nodePoolID]",
		...
		RunE: func(cmd *cobra.Command, args []string) error{
			...
			noderesponse, err := nodePoolService.Nodes(ctx, clusterID, nodePoolID)
			...
			beautiful.NewOutput(raw).PrintData(noderesponse)
			return nil
		},
	}
