...
*   FILE ID: base-cli-gen/cmd/gen/lbaas/networkbackends/list.go
*	
*	CUSTOM: base-cli-custom/cmd/gen/lbaas/networkbackends/list.go
*	
*/
...
func List(ctx context.Context, parent *cobra.Command, networkBackendService lbaasSdk.NetworkBackendService) {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error{
			...
			networkpaginatedbackendresponse, err := networkBackendService.List(ctx, lbID, options)
			...
			beautiful.NewOutput(raw).PrintData(networkpaginatedbackendresponse)
			return nil
		},
	}
