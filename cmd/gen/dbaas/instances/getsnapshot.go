...
*   FILE ID: base-cli-gen/cmd/gen/dbaas/instances/getsnapshot.go
*	
*	CUSTOM: base-cli-custom/cmd/gen/dbaas/instances/getsnapshot.go
*	
*/
...
func GetSnapshot(ctx context.Context, parent *cobra.Command, instanceService dbaasSdk.InstanceService) {
	...
	cmd := &cobra.Command{
		Use:     "get-snapshot [instanceID] [snapshotID]",
