...
func List(ctx context.Context, parent *cobra.Command, networkcertificatesService lbaasSdk.NetworkCertificateService) {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			result0, err := networkcertificatesService.List(ctx, lbID, options)
