...
func Get(ctx context.Context, parent *cobra.Command, schedulersService blockstorageSdk.SchedulerService) {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			var expand []blockstorageSdk.ExpandSchedulers
			//ServiceSDKParamCreate
			var id string
			...
			result0, err := schedulersService.Get(ctx, id, expand)
