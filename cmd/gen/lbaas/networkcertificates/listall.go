...
*   FILE ID: base-cli-gen/cmd/gen/lbaas/networkcertificates/listall.go
*	
*	CUSTOM: base-cli-custom/cmd/gen/lbaas/networkcertificates/listall.go
*	
*/
...
func ListAll(ctx context.Context, parent *cobra.Command, networkCertificateService lbaasSdk.NetworkCertificateService) {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error{
			...
			networktlscertificateresponse, err := networkCertificateService.ListAll(ctx, lbID)
