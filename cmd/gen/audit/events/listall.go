...
func ListAll(ctx context.Context, parent *cobra.Command, eventsService auditSdk.EventService) {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			var params *auditSdk.EventFilterParams

			//CobraStructInitialize
			params = &auditSdk.EventFilterParams{}
			...
			result0, err := eventsService.ListAll(ctx, params)
