...
*   FILE ID: base-cli-gen/cmd/gen/blockstorage/schedulers/listall.go
*	
*	CUSTOM: base-cli-custom/cmd/gen/blockstorage/schedulers/listall.go
*	
*/
...
func ListAll(ctx context.Context, parent *cobra.Command, schedulerService blockstorageSdk.SchedulerService) {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error{
			...
			filterOpts := blockstorageSdk.SchedulerFilterOptions{}// ServiceSDKParamCreate
			...
			schedulerresponse, err := schedulerService.ListAll(ctx, filterOpts)
