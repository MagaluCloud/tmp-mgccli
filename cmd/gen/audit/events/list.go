...
*   FILE ID: base-cli-gen/cmd/gen/audit/events/list.go
*	
*	CUSTOM: base-cli-custom/cmd/gen/audit/events/list.go
*	
*/
...
func List(ctx context.Context, parent *cobra.Command, eventService auditSdk.EventService) {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error{
			...
			params := auditSdk.ListEventsParams{}// ServiceSDKParamCreate
			...
			indexexpr, err := eventService.List(ctx, &params)
