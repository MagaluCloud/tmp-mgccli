...
func List(ctx context.Context, parent *cobra.Command, clustersService dbaasSdk.ClusterService) {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			var opts dbaasSdk.ListClustersOptions
			...
			if opts_StatusFlag.IsChanged() {
				localVar := dbaasSdk.ClusterStatus(*opts_StatusFlag.Value)
			...
			result0, err := clustersService.List(ctx, opts)
