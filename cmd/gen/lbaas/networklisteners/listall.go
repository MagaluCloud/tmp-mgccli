...
*   FILE ID: base-cli-gen/cmd/gen/lbaas/networklisteners/listall.go
*	
*	CUSTOM: base-cli-custom/cmd/gen/lbaas/networklisteners/listall.go
*	
*/
...
func ListAll(ctx context.Context, parent *cobra.Command, networkListenerService lbaasSdk.NetworkListenerService) {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error{
			...
			networklistenerresponse, err := networkListenerService.ListAll(ctx, lbID)
