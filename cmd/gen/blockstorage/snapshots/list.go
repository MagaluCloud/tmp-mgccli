...
func List(ctx context.Context, parent *cobra.Command, snapshotsService blockstorageSdk.SnapshotService) {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			var opts blockstorageSdk.SnaphotListOptions
			...
			if opts_ExpandFlag.IsChanged() {
				opts.Expand = flags.StrSliceFlagToSlice[blockstorageSdk.SnapshotExpand](opts_ExpandFlag)
